...
**使用前需要配置好iptables**
```
iptables -t nat -A PREROUTING -d 192.168.0.100 -p tcp --dport 501 -j DNAT --to-destination 192.168.0.100:1080
```
把发往本机的目标地址为501的tcp包发送至1080

再在防火墙界面配置1080为监听地址，某一个502为目标地址
